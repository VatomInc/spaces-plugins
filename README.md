...
| SMS Notification | Allows users to notify space hosts of their arrival into a space | [Here](./text-nofification) | <div style="display: flex;align-items: center;"><img src='https://avatars.githubusercontent.com/u/39608194?v=4' style="margin-right: 8px; width: 26px; height: 26px; border-radius: 15px;"><a href="https://github.com/zmaqutu">Zongo Maqutu</a></div> |
